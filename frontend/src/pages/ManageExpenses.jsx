            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                ...
                ${form.transactionType === value ? (c === "red" ? "border-red-400 bg-red-50 text-red-700" : "border-[#4caf50] bg-green-50 text-[#2e7d32]") : "border-gray-200 bg-gray-50 text-gray-600"}`}>
                    ...
                    <div className="flex gap-3 pt-1">
                        ...
                        <button type="submit" disabled={saving} className="flex-1 bg-[#4caf50] hover:bg-[#388e3c] text-white py-2 rounded-xl text-sm font-semibold transition-all hover:scale-105 active:scale-95 disabled:opacity-60 disabled:hover:scale-100 shadow-md">
            ...
            <div className="flex-1 flex flex-col max-w-7xl mx-auto w-full px-4 py-4 gap-4">
                ...
                {selected.size > 0 && (
                    <div className="flex items-center justify-between bg-[#2e7d32] text-white rounded-xl px-4 py-2.5 shadow-md">
                        ...
                        <button onClick={() => setDeleteTarget("bulk")} className="flex items-center gap-1.5 bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all hover:scale-105 active:scale-95 shadow-sm">
                            🗑️ Delete Selected
                        </button>
                    </div>
                )}
                                            ...
                                            <tr key={exp._id} className={`transition-colors ${selected.has(exp._id) ? "bg-green-50" : i % 2 === 0 ? "bg-white" : "bg-gray-50/50"} hover:bg-green-50/70`}>
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center justify-center gap-2">
                                                        <button onClick={() => setEditTarget(exp)} title="Edit" className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#e8f5e9] text-[#2e7d32] hover:bg-[#4caf50] hover:text-white transition-all hover:scale-110 active:scale-90">
                                                        ...
                                                        <button onClick={() => setDeleteTarget(exp._id)} title="Delete" className="w-8 h-8 flex items-center justify-center rounded-lg bg-red-50 text-red-500 hover:bg-red-500 hover:text-white transition-all hover:scale-110 active:scale-90">
